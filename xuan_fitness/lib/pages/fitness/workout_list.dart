...
class WorkoutList extends StatelessWidget {
  ...
  Widget build(BuildContext context){
    return Consumer(
        builder: (context, WorkoutRepository workoutRepository, _) {
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: ListView.builder(
                        ...
                        shrinkWrap: true,
                        itemCount: fitnessRepo.sections.length, // your List
                        itemBuilder: (context, index) {
                          return fitnessRepo.sections[index].build(this.setBody);
                        },
                      ),
                    ),
                  ])
